...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 28 08:44:23 2018
...
if __name__ == "__main__":
    ...
    bayesian_indep = bayesian_estimator.BayesianEstimator()
    datasets = get_datasets('../data/gender_compositions/', preferences.CLASSES)
